...
import { View, Text, Image, TouchableOpacity, FlatList, ScrollView, RefreshControl, BackHandler } from 'react-native';
    ...
    <View className="bg-white p-4 my-2 rounded-lg border border-gray-300">
      <View className="flex-row">
        <View className="h-14 w-14 justify-center items-center bg-red-200 rounded-md mr-2 mt-3">
          <FontAwesome name='hospital-o' size={23} color={"red"} />
        </View>
...
const OrganizationScreen = () => {
  ...
  const getinfo = ()=>{
    getdata({query:{district:city},table:"organizations"})
    .then((res)=>{
        setmaindata(res)
