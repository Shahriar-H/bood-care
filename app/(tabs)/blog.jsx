...
import { View, Text, Image, ScrollView, TextInput, TouchableOpacity, BackHandler } from 'react-native';
  ...
  return (
    <ScrollView className="bg-white p-4">
      ...
      <View className="space-y-4">
        {/* Blog Post 1 */}
        {!isLoading&&blogs?.length<1&&<View className="flex justify-center items-center">
            <Image
        ...
        {
          isLoading&&<Text className="text-center bg-red-200 p-2 rounded-md">Loading...</Text>
        }
