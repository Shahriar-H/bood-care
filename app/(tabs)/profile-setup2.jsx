...
import { View, Text, TextInput, TouchableOpacity, Platform, ToastAndroid, ScrollView, BackHandler } from 'react-native';
...
export default function ProfileSetupScreen2() {
  ...
  useEffect(() => {
    ...
    const backAction = () => {
      ...
      router.push('profile-setup1'); // Navigate to the 'Another' screen
  ...
  return (
    <ScrollView className="flex-1 bg-white px-6 py-4">
      ...
      <Text className="text-lg font-semibold text-center mb-4">More Information</Text>
      ...
      >
        <Text className="text-center text-white font-bold text-lg">{isLoading?"Saving...":'Save'}</Text>
      </TouchableOpacity>
    </ScrollView>
  );
}
